...
public enum ModOption {
    ...
    SHOW_RARITY(new BooleanDataEntry("rarity",false, 0), ModCategory.TOOLTIP_TOGGLES),
    ...
    DECORATION(new ColorDataEntry("decoration", 0x4f4f47, 0), ModCategory.TOOLTIP_COLORS),

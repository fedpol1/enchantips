...
public enum ModOption {
    ...
    MODIFIED_ENCHANTMENT_LEVEL(new ColorDataEntry("modified_level", 0xdf9f3f, false), ModCategory.TOOLTIP_COLORS),
    MODIFIED_ENCHANTMENT_LEVEL_VALUE(new ColorDataEntry("modified_level.value", 0xdf7f3f, false), ModCategory.TOOLTIP_COLORS),

...
public class ModConfigData {
    ...
    public static EnchantmentGroupNode get(ResourceKey<Enchantment> e) {
        return ModConfigData.enchantmentData.get(e.identifier().toString());
    }
    ...
    public static boolean isEnchantmentHighlighted(ResourceKey<Enchantment> e) {
        return (boolean) ((OptionNode<?>) ModConfigData.get(e).getHighlight()).getValue();
    }

    public static int getEnchantmentOrder(ResourceKey<Enchantment> e) {
